        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Form(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: ScreenUtil().setHeight(10)),
                    inputfield(_passwordController, "Password", obsecureText1),
                    SizedBox(height: ScreenUtil().setHeight(16)),
                    textBeforeInput("Confirm Password"),
                    SizedBox(height: ScreenUtil().setHeight(10)),
                    inputfield(_confirmPasswordController, "Confirm Passowrd",
                        obsecureText2)
                  ],
                ),
              ),
              ...
              Center(
                child: Text("or use", style: TextStyle(color: ColorConst.grey)),
              ),
              SizedBox(
                height: ScreenUtil().setHeight(24),
              ),
